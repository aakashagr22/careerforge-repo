    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          type={type}
          ref={ref}
          className={`w-full px-4 py-2.5 rounded-xl border bg-slate-50/50 dark:bg-zinc-800/10 text-slate-800 dark:text-slate-200 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-500/20 disabled:opacity-50 disabled:cursor-not-allowed ${
            error
